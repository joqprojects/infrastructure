...
check_app_started(AppIdStart,VsnStart,[{AppId,Vsn,_StartedServices}|T],Acc)->
...
%		  io:format(" NfviCandidates ~p~n",[{?MODULE,?LINE,{IpAddrNfvi,PortNfvi,LocalIpNfvi,LocalPortNfvi}}]),
		  case rpc:call(node(),tcp,call,[IpAddrNfvi,PortNfvi,{nfvi,deploy_service,[IpAddrNfvi,PortNfvi,ServiceId,Vsn]}]) of
